...
| ④ contrib | base64・email・modbus・mqtt 完了 |
...
| 区分 | ノード | 補足 |
| --- | --- | --- |
| 次フェーズ | dashboard2 ウィジェット 6 本 | ui-led / widgets-display / widgets-input / widgets-visualization / widgets-advanced-part1 / widgets-advanced-part2。いずれも Dashboard 2.0 で ja ロケール無し（英語表示）→「英語ラベル（日本語訳）」形式 |
